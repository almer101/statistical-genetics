...
cat("The p-value is small enough so we reject the Equilibrium hypothesis, i.e. there exists some correlation between the 2 SNPs.")
```
...
For filtered variants there should be at least 2400 pairs which are correlated. The red triangles divide the height in roughly 3 parts, and we have 3 halves of a square with side length of 119/3.
